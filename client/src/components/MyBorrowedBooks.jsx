    ...
    <>
      <main className="relative flex-1 p-6 pt-28">
        ...
        <header className="flex flex-col gap-3 sm:flex-row md:items-center">
          ...
          <button
            className={`relative rounded sm:rounded-tl-none sm:rounded-bl-none sm:rounded-tr-lg sm:rounded-br-lg text-center border-2 font-semibold py-2 w-full sm:w-72 ${filter == "notReturned" ? "bg-black text-white border-black" : "bg-gray-200 text-black border-gray-200 hover:bg-gray-300"}`}
                ...
                {booksToDisplay.map((book, idx) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">
                      {books.find((b) => b._id === book.bookId)?.title ||
                        "Book not found"}
                    </td>
                    <td className="px-4 py-2">
