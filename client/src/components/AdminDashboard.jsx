...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    let noOfTotalBorrowedBooks = allBorrowedBooks.filter(
      (book) => book.returnDate == null,
    );
    let noOfTotalReturnedBooks = allBorrowedBooks.filter(
      (book) => book.returnDate != null,
    );
      ...
      <main className="relative flex-1 p-6 pt-28">
        ...
        <div className="flex flex-col-reverse xl:flex-row">
          ...
          <div className="flex flex-[4] flex-col gap-7 lg:gap-16 lg:px-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
            ...
            <div className="hidden xl:flex bg-white p-7 text-lg sm:text-xl xl:text-2xl 2xl:text-3xl min-h-52 font-semibold relative flex-[3] justify-center items-center rounded-2xl">
